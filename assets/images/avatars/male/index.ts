...
const jpg7: AvatarBuffer = {
  data: fs.readFileSync(path.join(__dirname, '7.jpg')),
  contentType: 'image/jpeg',
};
const jpg8: AvatarBuffer = {
  data: fs.readFileSync(path.join(__dirname, '8.jpg')),
  contentType: 'image/jpeg',
};
const jpg9: AvatarBuffer = {
  data: fs.readFileSync(path.join(__dirname, '9.jpg')),
  contentType: 'image/jpeg',
};
const jpg10: AvatarBuffer = {
  data: fs.readFileSync(path.join(__dirname, '10.jpg')),
  contentType: 'image/jpeg',
};
